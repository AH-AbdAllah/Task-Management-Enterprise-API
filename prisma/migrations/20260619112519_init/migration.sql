-- CreateEnum
CREATE TYPE "GlobalRole" AS ENUM ('SYSTEM_ADMIN', 'ORG_OWNER', 'PROJECT_MANAGER', 'DEVELOPER', 'VIEWER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_MOVED', 'TASK_UPDATED', 'COMMENT_ADDED', 'TEAM_MEMBER_ADDED', 'DEADLINE_APPROACHING');
...
CREATE TABLE "User" (
    ...
    "name" TEXT NOT NULL,
    "role" "GlobalRole" NOT NULL DEFAULT 'DEVELOPER',
...
CREATE TABLE "Attachment" (
    ...
    "mimeType" TEXT,
    "bucketName" TEXT NOT NULL DEFAULT 'task-attachments',
